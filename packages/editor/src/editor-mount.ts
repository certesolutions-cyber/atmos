...
import type { Scene, DeserializeContext, Component } from '@atmos/core';
import { Camera } from '@atmos/renderer';
import type { CameraSettings, RenderSystem } from '@atmos/renderer';
